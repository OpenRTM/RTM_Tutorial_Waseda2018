  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  RobotController(RTC::Manager* manager);
 ...
 protected:
  ...
  RTC::TimedShortSeq m_in;
  /*!
   * 距離センサのデータを入力
   * - Type: RTC::TimedShortSeq
   * - Number: 4
   */
  InPort<RTC::TimedShortSeq> m_inIn;
...
extern "C"
{
  DLL_EXPORT void RobotControllerInit(RTC::Manager* manager);
};
