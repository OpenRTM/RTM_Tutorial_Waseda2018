...
#ifndef TESTARTOOLKIT_H
#define TESTARTOOLKIT_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  testARToolKit(RTC::Manager* manager);
 ...
 protected:
   ...
   * - Unit: m,rad
   */
  InPort<RTC::TimedPose3D> m_marker_posIn;
   ...
   * - Unit: m, rad
   */
  OutPort<RTC::TimedVelocity2D> m_target_velOut;
...
extern "C"
{
  DLL_EXPORT void testARToolKitInit(RTC::Manager* manager);
};

#endif // TESTARTOOLKIT_H
