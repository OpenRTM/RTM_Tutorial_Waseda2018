...
#ifndef FLOATSEQTOVELOCITY_H
#define FLOATSEQTOVELOCITY_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  FloatSeqToVelocity(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void FloatSeqToVelocityInit(RTC::Manager* manager);
};

#endif // FLOATSEQTOVELOCITY_H
